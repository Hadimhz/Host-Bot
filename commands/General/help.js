...
module.exports.run = (client, message, args) => {
    ...
    let embed = new MessageEmbed()
        .setTitle("DanBot Hosting Bot Help").setColor("#36393F").setDescription("Here is a list of commands that you can use! Use DBH!help <name> to get help with a specific command!")
